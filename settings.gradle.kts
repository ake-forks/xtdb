...
include("modules:kafka", "modules:kafka-connect", "modules:kafka-source", "modules:postgres-source", "modules:aws", "modules:azure", "modules:google-cloud")
project(":modules:kafka").name = "xtdb-kafka"
project(":modules:kafka-connect").name = "xtdb-kafka-connect"
project(":modules:kafka-source").name = "xtdb-kafka-source"
